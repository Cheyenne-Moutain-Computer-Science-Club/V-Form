...
export default function FormTaking(
	...
	const [questionResponses, setQuestionResponses] = useState(
		Array(value?.questions.length).fill("")
	);
	...
	const questionComponents = questionsData?.map((q: Question, i: number) => {
		return (
			<div className="my-8 shadow-lg" key={i}>
				<div className="bg-accent flex h-12 items-center justify-between rounded-t px-3">
